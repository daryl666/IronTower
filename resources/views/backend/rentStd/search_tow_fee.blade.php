            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        <option selected="selected">铁塔基准价格</option>
                ...
                @if(isset($tow_fees))
                    @foreach($tow_fees as $tow_fee)
                        <tr>
                            ...
                            {{--</td>--}}
                            <td>{{transTowerType($tow_fee->tower_type) }}</td>
                            <td>{{transSysHeight($tow_fee->sys_height) }}</td>
                            <td>{{transIsNewTower($tow_fee->is_new_tower) }}</td>
                            <td>{{ $tow_fee->fee_tower}}</td>
                        </tr>
                    @endforeach
                @endif
