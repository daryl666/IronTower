            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        ...
                        <option selected="selected">机房基准价格</option>
                ...
                @if(isset($hou_fees))
                    @foreach($hou_fees as $hou_fee)
                        <tr>
                            ...
                            {{--</td>-->--}}
                            <td>{{transTowerType($hou_fee->tower_type) }}</td>
                            <td>{{transProductType($hou_fee->product_type) }}</td>
                            <td>{{transIsNewTower($hou_fee->is_new_tower) }}</td>
                            <td>{{$hou_fee->fee_house}}</td>
                        </tr>
                    @endforeach
                @endif
