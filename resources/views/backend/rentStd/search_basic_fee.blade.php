                ...
                @if(isset($basic_fees))
                    @foreach($basic_fees as $basic_fee)
                        <tr>
                            ...
                            <td>{{transTowerType($basic_fee->tower_type) }}</td>
                            <td>{{transSysHeight($basic_fee->sys_height) }}</td>
                            <td>{{transProductType($basic_fee->product_type) }}</td>
                            <td>{{transIsNewTower($basic_fee->is_new_tower) }}</td>
