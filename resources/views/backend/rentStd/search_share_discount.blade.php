                ...
                @if(isset($share_discounts))
                    @foreach($share_discounts as $share_discount)
                        <tr>
                            ...
                            <td>{{transIsNewTower($share_discount->is_new_tower) }}</td>
                            <td>{{transShareType($share_discount->share_num) }}</td>
                            <td>{{transUserType($share_discount->user_type) }}</td>
                            <td>{{transIsNewlyAdded($share_discount->is_newly_added) }}</td>
