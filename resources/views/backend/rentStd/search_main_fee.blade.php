            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        ...
                        <option selected="selected">维护费</option>
                        <option>场地费</option>
                        <option>电力引入费</option>
                        <option>共享折扣</option>
                    </select>
                ...
                @if(isset($main_fees))
                    @foreach($main_fees as $main_fee)
                        <tr>
                            ...
                            {{--</td>-->--}}
                            <td>{{transTowerType($main_fee->tower_type) }}</td>
                            <td>{{transProductType($main_fee->product_type) }}</td>
                            <td>{{transIsNewTower($main_fee->is_new_tower) }}</td>
                            <td>{{$main_fee->fee_maintain}}</td>
                        </tr>
                    @endforeach
                @endif
