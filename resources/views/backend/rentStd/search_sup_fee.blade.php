            ...
            <form id="listForm" method="post" target="_self" action="{{url('backend/rentStd/fee_std_search')}}">
                ...
                <div class="listBar">
                    ...
                    <select name="fee_type">
                        ...
                        <option selected="selected">配套基准价格</option>
                        <option>维护费</option>
                        <option>场地费</option>
                        <option>电力引入费</option>
                        <option>共享折扣</option>
                ...
                @if(isset($sup_fees))
                    @foreach($sup_fees as $sup_fee)
                        <tr>
                            ...
                            {{--</td>--}}
                            <td>{{transTowerType($sup_fee->tower_type) }}</td>
                            <td>{{transProductType($sup_fee->product_type) }}</td>
                            <td>{{transIsNewTower($sup_fee->is_new_tower) }}</td>
                            <td>{{$sup_fee->fee_support}}</td>
                        </tr>
                    @endforeach
                @endif
