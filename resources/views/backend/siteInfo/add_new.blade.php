        ...
        <div class="input managerInfo">
            ...
            <table class="inputTable tabContent">
                <tr>
                    ...
                    {{--<td>--}}
                        {{--<input type="file" name="ironTowerSiteInfoFile" style="width: 170px" id="ironTowerSiteInfoFile">--}}
                        {{--<input type="button" class="formButton" value="转换" onclick="doImportIronTowerSiteInfo()"/>--}}
                    {{--</td>--}}
                </tr>
            </table>
        </div>
        ...
        <div class="input managerInfo" style="margin-top: 25px;">
            <div class="bar">
                <div style="float:left;">
                    人工填写&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="{{url('backend/siteInfo/addNewPage')}}" style="color: #337ab7">新建站</a>
                    <a href="{{url('backend/siteInfo/addOldPage')}}">存量站</a>
                </div>
