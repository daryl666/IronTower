        ...
        <table class="inputTable tabContent">
            <tr>
                ...
                <td>
                    --}}
                        {{--
                    <input id="ironTowerSiteInfoFile" name="ironTowerSiteInfoFile" style="width: 170px" type="file">
                        --}}
                        {{--
                        <input class="formButton" onclick="doImportIronTowerSiteInfo()" type="button" value="转换"/>
                        --}}
                    {{--
                    </input>
                </td>
    ...
    <div class="input managerInfo" style="margin-top: 25px;">
        ...
        <table class="inputTable tabContent">
            ...
            <tr>
                ...
                <td>
                    <input id="establishedTime" name="establishedTime" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="true" style="width:65px;padding-left:5px" type="text"/>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    <input checked="checked" id="towerType" name="towerType" onclick="towerTypeChange(this)" type="radio" value="普通地面塔">
                        普通地面塔
                        <input id="towerType" name="towerType" onclick="towerTypeChange(this)" type="radio" value="景观塔">
                            ...
                            <input id="towerType" name="towerType" onclick="towerTypeChange(this)" type="radio" value="简易塔">
                                简易塔
                                <input id="towerType" name="towerType" onclick="towerTypeChange(this)" type="radio" value="普通楼面塔">
                                    普通楼面塔
                                    <input id="towerType" name="towerType" onclick="towerTypeChange(this)" type="radio" value="楼面抱杆">
                                        楼面抱杆
                                    </input>
                                </input>
                            </input>
