    ...
    <div class="list">
        <div class="body">
            <form id="listForm" method="post" action="{{url('backend/siteShield')}}" enctype="multipart/form-data">
                ...
                <div class="listBar">
                    <label style="margin-bottom:10px">选择起止月份和地市来查看屏蔽记录：</label><br>
...
@section('script_footer')
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            var url = "{{url('backend/siteShield/checkShieldPage?region=')}}" + region + '&beginDate=' + beginDate + '&endDate=' + endDate;
            listForm.method = "GET";
            listForm.action = url;
            listForm.submit();
        }
