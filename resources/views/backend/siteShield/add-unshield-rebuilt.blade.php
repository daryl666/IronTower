    ...
    <form id="listForm" method="POST" action="{{url('backend/siteCheck/handle')}}" style="display: inline;">
        ...
        <table class="inputTable tabContent">
            ...
            <tr>
                <th>新基站编号(*必填项)：</th>
                <td>
                    <input type="text" name="newStationCode" id="newStationCode">
                </td>
            </tr>
            <tr>
                <th>新基站名称(*必填项)：</th>
                <td>
                    <input type="text" name="newStationName" id="newStationName">
                </td>
            </tr>
            <tr>
                <th>新站址编码(*必填项)：</th>
                <td>
                    <input type="text" name="newSiteCode" id="newSiteCode">
                </td>
            </tr>
...
@section('script_footer')
    <script type="text/javascript">
        ...
        function doAddUnshield(id) {
            var newStationCode = $('#newStationCode').val();
            var newStationName = $('#newStationName').val();
            var newSiteCode = $('#newSiteCode').val();
            if (newStationCode == ''){
                alert('请输入新基站编号！');
                return;
            }
