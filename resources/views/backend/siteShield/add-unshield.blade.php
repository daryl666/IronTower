                ...
                @if(isset($siteShields))
                    @foreach($siteShields as $siteShield)
                        <tr>
                            <td>
                                @if(Auth::user()->area_level != '湖北省')
                                    <button class="buttonNextStep" onclick="doAddUnshieldPage({{$siteShield->id}})">
                                        申请解屏蔽
                                    </button>@endif
                            </td>
...
@section('script_footer')
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            var url = "{{url('backend/siteShield/shieldCheckingPage?region=')}}" + region + '&beginDate=' + beginDate + '&endDate=' + endDate;
            listForm.method = "GET";
            listForm.action = url;
            listForm.submit();
        }
        ...
        function doUnshield() {
            var listForm = document.getElementById("listForm");
            listForm.action = "{{url('backend/siteShield/addUnshieldPage')}}";
            listForm.submit();
        }
        ...
        function doAddUnshieldPage(id) {
            var listForm = document.getElementById("listForm");
            var url = "{{url('backend/siteShield/addUnshieldPage')}}" + '/' + id;
            listForm.action = url;
            listForm.submit();
        }
