        ...
        <div class="body">
            <form id="listForm" method="post" action="{{url('backend/siteShield')}}" enctype="multipart/form-data">
                ...
                <div class="listBar">
                    ...
                    {{--<td>--}}
                    {{--&nbsp;&nbsp;&nbsp;&nbsp;审核状态：--}}
                    {{--<input type="radio" name="checkStatus" value="0" checked="checked"/>待审核--}}
        ...
        <div id="siteCheck">
            <table class="listTable" style="white-space:nowrap;font-size:12px;">
                ...
                @if(isset($siteShields))
                        ...
                        <tr>
                            <td>
                                ...
                                @if(Auth::user()->area_level == '湖北省')
                                    ...
                                    <button class="buttonNextStep" onclick="doDeny({{$siteShield->id}})">驳回
                                    </button>@endif
                            </td>
                    ...
                    @endforeach
                @endif
                @if(isset($filter)){!! $siteShields->appends(['region' => $filter['region'],'beginDate' => $filter['beginDate'],'endDate' => $filter['endDate']])->links() !!}@endif
...
@section('script_footer')
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            var url = "{{url('backend/siteShield/checkUnshieldPage?region=')}}" + region + '&beginDate=' + beginDate + '&endDate=' + endDate;
            listForm.method = "GET";
            listForm.action = url;
            listForm.submit();
        }
