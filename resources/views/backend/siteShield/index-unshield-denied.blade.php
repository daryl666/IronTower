        ...
        <div class="body">
            <form id="listForm" method="post" action="{{url('backend/siteShield')}}" enctype="multipart/form-data">
                ...
                <div class="listBar">
                    ...
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;审核状态：
                        <input type="radio" name="checkStatus" value="1"/>待审核
                        <input type="radio" name="checkStatus" value="2"/>审核通过
                        <input type="radio" name="checkStatus" value="3" checked="checked"/>审核不通过
                    </td>
                    {{--<td>--}}
                        {{--&nbsp;&nbsp;&nbsp;&nbsp;记录类型：--}}
                    ...
                    {{--<td style="float:right;margin-right:30px;">--}}
                        {{--<input type="button" class="formButton" value="新增记录" id="addBtn" style="float: right;" onclick="doAddShieldPage()"/>--}}
                    {{--</td>--}}
...
//            $('#menu_deduction').addClass("current");
        });
