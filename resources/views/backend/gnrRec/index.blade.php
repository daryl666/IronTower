    ...
    <div class="list">
        <form id="listForm" method="post" action="{{url('backend/gnrRec/')}}" enctype="multipart/form-data">
            <div class="body">
                ...
                {{--@if(isset($siteInfos) && isset($filter['siteChoose'])) value="{{$siteInfos[0]->id}}"@endif>--}}
                ...
                <div class="listBar">
                    <label style="margin-bottom:10px">选择起止月份和地市来查看发电记录：</label><br>
            ...
            {{--<tr>--}}
            {{--<td @if(isset($filter['siteChoose'])) style="display: none" @endif><input type="radio"--}}
            {{--name="siteChoose"--}}
            {{--value="{{$infoSite->id}}"--}}
            {{--onclick="doChoose()"/>--}}
            {{--</td>--}}
