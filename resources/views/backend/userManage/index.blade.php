                            ...
                            @if($user->area_level != 'admin')
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" name="permission_{{$user->id}}[]"
                                               value="site_view_advance"
