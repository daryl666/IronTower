        ...
        <table class="listTable" style="white-space:nowrap;" id="servBill">
            ...
            @foreach($feeouts as $feeout)
                <tr>
                    ...
                    <td>{{$feeout->month}}</td>
                    <td>{{$feeout->fee_service}}
                        @if($feeout->fee_service != 0)
                            <a href="javascript:viewBillSites('{{$feeout->id}}')">明细</a>
                        @endif
                    </td>
                    <td>
                        {{formatNumber($feeout->fee_service * 1.06)}}
                    </td>
                    <td>
                        {{$feeout->fee_gnr_allincharge}}
                    </td>
                    <td>
                        {{formatNumber($feeout->fee_gnr_allincharge * 1.06)}}
                    </td>
                    <td>
                        {{($feeout->fee_gnr)}}
                        @if($feeout->fee_gnr != 0)
                    ...
                    <td>{{formatNumber($feeout->fee_total_succ * 1.06)}}</td>
                    <td id="toGenBill">
