...
@section('content')
    ...
    <form id="listForm" method="POST" action="{{url('backend/siteInfo/update')}}" style="display: inline;">
        ...
        {{--<input type="hidden" name="id" value="{{$telecomOrder->id}}"/>--}}
        {{--<input name="region" type="hidden" value="{{$filter['region']}}">--}}
        {{--<input type="hidden" name="isNewTower" value="{{$telecomOrder->is_new_tower}}">--}}
        {{--<input type="hidden" name="siteCode" value="{{$telecomOrder->site_code}}">--}}
        <table class="inputTable tabContent">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text"
                           @if(isset($telecomOrder->region_name)) value="{{$telecomOrder->region_name}}" @endif id="region" name="regionName"
                           readonly>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="towerType" id="towerType" value="普通地面塔"
                           @if(isset($telecomOrder->tower_type) && transTowerType($telecomOrder->tower_type) =="普通地面塔") checked="checked" @endif
                           onclick="towerTypeChange(this)">普通地面塔
                    <input type="radio" name="towerType" id="towerType" value="景观塔"
                           @if(isset($telecomOrder->tower_type) && transTowerType($telecomOrder->tower_type)=="景观塔") checked="checked" @endif
                           onclick="towerTypeChange(this)">景观塔
                    <input type="radio" name="towerType" id="towerType" value="简易塔"
                           @if(isset($telecomOrder->tower_type) && transTowerType($telecomOrder->tower_type)=="简易塔") checked="checked" @endif
                           onclick="towerTypeChange(this)">简易塔
                    <input type="radio" name="towerType" id="towerType" value="普通楼面塔"
                           @if(isset($telecomOrder->tower_type) && transTowerType($telecomOrder->tower_type)=="普通楼面塔") checked="checked" @endif
                           onclick="towerTypeChange(this)">普通楼面塔
                    <input type="radio" name="towerType" id="towerType" value="楼面抱杆"
                           @if(isset($telecomOrder->tower_type) && transTowerType($telecomOrder->tower_type)=="楼面抱杆") checked="checked" @endif
