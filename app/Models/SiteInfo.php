...
//                        'updated_at' => date('Y-m-d h:i:s',time())
    ...
    public
    function addInfoSiteOld(Request $request)
    {
        //插入站址属性信息
        $business_code = $request->get('businessCode');
        $site_code = $request->get('siteCode');
...
//                        'updated_at' => date('Y-m-d h:i:s',time())
    ...
    public
    function addInfoSiteByArray(Array $infoSites, $area_level)
    {
...
//                        'updated_at' => date('Y-m-d h:i:s',time())
    ...
    public
    function transIronTowerSiteInfo(Array $infoSites, $area_level)
    {
        if ($area_level == 'admin' || $area_level == '湖北省') {
            for ($i = 1; $i < count($infoSites); $i++) {
