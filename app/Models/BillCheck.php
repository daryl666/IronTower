...
//            ->get();
//
//        dd($teacher_student_second);

        $telecomOrders = DB::table('fee_out_site')->leftJoin('site_info', 'site_info.business_code', '=', 'fee_out_site.business_code')
        ...
        $telecomBusinessCodes = $telecomOrders->groupBy('business_code')->pluck('business_code');
        $orders = DB::table('irontower_bill_detail')->where('irontower_bill_detail.month', $month)
            ...
            ->whereNotIn('irontower_bill_detail.business_code', array_filter($telecomBusinessCodes))
            ->unionAll($telecomOrders)
            ->select(DB::raw('fee_out_site.id as fos_id, fee_out_site.out_id as fos_out_id, fee_out_site.region_id as region_id, fee_out_site.region_name as region_name, irontower_bill_detail.business_code as business_code, fee_out_site.req_code as req_code, fee_out_site.site_code as site_code, fee_out_site.start_day as month, fee_out_site.fee_tower as fee_tower_fos, fee_out_site.fee_house as fee_house_fos, fee_out_site.fee_support as fee_support_fos, fee_out_site.fee_maintain as fee_maintain_fos, fee_out_site.fee_site as fee_site_fos, fee_out_site.fee_import as fee_import_fos, fee_out_site.fee_gnr_allincharge as fee_gnr_allincharge_fos, fee_out_site.fee_wlan as fee_wlan_fos, fee_out_site.fee_microwave as fee_microwave_fos, fee_out_site.fee_add as fee_add_fos, fee_out_site.fee_battery as fee_battery_fos, fee_out_site.fee_bbu as fee_bbu_fos, fee_out_site.fee_service as fee_service_fos, 
